...
-(void)setFooterFrame:(UIScrollView *)scrollView{
    self.frame = CGRectMake(0, 0, SCREEN_WIDTH, SVInfiniteScrollingViewHeight);
    scrollView.infiniteScrollingView.frame = CGRectMake(0, scrollView.superview.height, SCREEN_WIDTH, SVInfiniteScrollingViewHeight);
    @weakify(scrollView);
    [[RACObserve(scrollView, contentSize) filter:^BOOL(id value) {
        ...
        @strongify(scrollView);
        scrollView.infiniteScrollingView.frame = CGRectMake(0, scrollView.contentSize.height, SCREEN_WIDTH, SVInfiniteScrollingViewHeight);
    }];
}
